...
namespace Examen_Torres_Reyes.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(BD_Vicente_TorresContext context)
        {
            _context = context;
        }
        ...
        {
            var bD_Vicente_TorresContext = _context.Proveedors.Include(p => p.Ubicacion);
            return View(await bD_Vicente_TorresContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BD_Vicente_TorresContext.Proveedors'  is null.");
            }
            var proveedor = await _context.Proveedors.FindAsync(id);
            if (proveedor != null)
            {
